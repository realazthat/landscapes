...
cmake -G"$CMAKE_GENERATOR" .. \
    ...
    -DCMAKE_VERBOSE_MAKEFILE=1 -DCEGUI_BUILD_FREEIMAGE=0 -DCEGUI_BUILD_FREETYPE2=1 -DCEGUI_BUILD_SILLY=1 \
    -DCEGUI_BUILD_EXPAT=1 -DCEGUI_BUILD_TINYXML=1 \
...
mkdir -p ./dependencies/bin/ && touch ./dependencies/bin/ignorethisfile
